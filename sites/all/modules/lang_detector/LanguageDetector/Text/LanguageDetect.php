...
require_once drupal_get_path('module', 'lang_detector') . '/LanguageDetector/Text/LanguageDetect/Exception.php';
require_once drupal_get_path('module', 'lang_detector') . '/LanguageDetector/Text/LanguageDetect/Parser.php';
require_once drupal_get_path('module', 'lang_detector') . '/LanguageDetector/Text/LanguageDetect/ISO639.php';
